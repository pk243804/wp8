...
function custom_portfolio() {
   ...
   // register taxonomy
    register_taxonomy('portfolio_category', 'portfolio', array('hierarchical' => true, 'label' => 'Category', 'query_var' => true, 'rewrite' => array( 'slug' => 'portfolio-category' )));
}
