...
<html class="no-js" <?php language_attributes(); ?>>
	...
	<head>
        ...
        <!-- Favicons -->
	  <link href="<?php bloginfo('template_directory');?>/assets/images/favicon.png" rel="icon">
	  <link href="<?php bloginfo('template_directory');?>/assets/images/apple-touch-icon.png" rel="apple-touch-icon">
	  ...
	  <link href="<?php bloginfo('template_directory');?>/assets/vendor/boxicons/css/boxicons.min.css" rel="stylesheet">
	  <link href="<?php bloginfo('template_directory');?>/assets/vendor/glightbox/css/glightbox.css" rel="stylesheet">
